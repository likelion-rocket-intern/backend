...
Revision ID: b09f1a3fd0e2
Revises: 
Create Date: 2025-07-21 14:47:06.046579
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['jinro_id'], ['job_profiles.id'], ),
    ...
    op.create_table('job_description_results',
    sa.Column('id', sa.Integer(), nullable=False),
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table('job_description_results')
